...
Исходный код для измерения времени лежит в файле `testing/benchmark3.cpp`, результаты измерений лежат в файле `testing/data/bench3.txt`. Результаты измерений с оптимизациями лежат в файле `testing/data/bench3_cmp2.txt`.
